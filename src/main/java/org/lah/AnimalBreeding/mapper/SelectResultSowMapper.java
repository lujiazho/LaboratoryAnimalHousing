 ...
 * 母猪档案
 */
public interface SelectResultSowMapper {
    //获取母猪档案总条数
    ...
    //获取母猪档案
    public List<SelectResultSow> getSelectResultSow(@Param("AnimalNumber") String AnimalNumber,
                                                      @Param("PigAge") Integer PigAge,
                                                      @Param("HealthCondition") String HealthCondition,
                                                      @Param("LifeCondition") String LifeCondition,
                                                      @Param("Fertility") String Fertility,
    ...
    public int updateSelectResultSow(String AnimalNumber);          //修改指定ID的母猪档案信息
    public SelectResultSow findSelectResultSowById(String AnimalNumber); //根据ID查询母猪档案信息
    public List<SelectResultSow> getAll();                       //查询所有母猪档案信息
}
