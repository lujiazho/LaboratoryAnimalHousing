...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            /** 员工表单提交 */
            $("#wasteForm").submit(function(){
                var wasteweight = $("#wasteweight").val();
                alert(wasteweight)

                var msg = "";
                if ($.trim(wasteweight.val()) == ""){
                    msg = "重量不能为空！";
                    wasteweight.focus();
                }
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td class="main_locbg font2"><img src="${pageContext.request.contextPath}/resources/ZLJ_resources/images/waste_images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：废料管理  &gt; 添加记录</td>
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
    <tr valign="top">
        <td>
            <form action="/LaboratoryAnimalHousing/waste/addWaste" id="wasteForm" method="post">
                <!-- 隐藏表单，flag表示添加标记 -->
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
                    <tr><td class="font3 fftd">
                        <table>
                            <tr>
                                <td class="font3 fftd">垃圾种类：
                                    <select name="wastetype" style="width:143px;">
                            ...
                            <tr>
                                <td class="font3 fftd">可否回收：
                                    <select name="recycable" style="width:143px;">
                                        <option value="0">--请选择--</option>
                            ...
                            <tr>
                                <td class="font3 fftd">产生重量：<input name="wasteweight" id="wasteweight" size="20" /></td>
                            </tr>
                        </table>
                    </td></tr>
