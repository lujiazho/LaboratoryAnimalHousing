...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="">设备管理系统</a></div>
    <div class="left_open">
    ...
    <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="/LaboratoryAnimalHousing/equip/selectMaintenance" onclick="waiting()">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>检修登记</cite>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="/LaboratoryAnimalHousing/equip/selectEquip" onclick="waiting()">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>设备信息列表</cite>
                        </a>
                    ...
                    <li>
                        <a _href="/LaboratoryAnimalHousing/equip/selectEquipName" onclick="waiting()">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>扩展设备名称</cite>
                        </a>
                    ...
                    <li>
                        <a _href="/LaboratoryAnimalHousing/equip/selectEquipSpec" onclick="waiting()">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>扩展设备型号</cite>
                        </a>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="/LaboratoryAnimalHousing/equip/selectApplication" onclick="waiting()">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>申购记录</cite>
                        </a>
