...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td class="main_locbg font2"><img src="${pageContext.request.contextPath}/resources/ZLJ_resources/images/waste_images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：设备 &gt; 扩展设备名称</td>
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
    <tr valign="top">
        <td>
            <form action="/LaboratoryAnimalHousing/equip/extendEquipName" id="nameForm" method="post">
                <!-- 隐藏表单，flag表示添加标记 -->
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
                    <tr><td class="font3 fftd">
                        <table>
                            <tr>
                                <td class="font3 fftd">设备名称：<input type="text" name="name" id="name" size="20"/></td>
                            </tr>
