<%@ page contentType="text/html;charset=UTF-8" language="java"  import="org.lah.AnimalBreeding.domain.SelectSituationSow" %>
...
<div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="">首页</a>
        <a href="/LaboratoryAnimalHousing/findSelectSituationSow">母猪档案</a>
      </span>
</div>
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/LaboratoryAnimalHousing/findSelectSituationSow" >
    ...
    <xblock>
        <a class="layui-btn" href="/LaboratoryAnimalHousing/findSelectSituationSow" title="刷新"><i class="layui-icon">&#xe669;</i>刷新</a>
    ...
    <table class="layui-table">
        ...
        <tbody>
        <c:forEach items="${pi.list}" var="selectSituationSow">
        <tr>
            <td>${selectSituationSow.getAnimalNumber()}</td>
            <td>${selectSituationSow.getPigAge()}</td>
            <td>${selectSituationSow.getHealthCondition()}</td>
            <td>${selectSituationSow.getLifeCondition()}</td>
            <td>
                <a title="添加健康及生活情况" id= "updateEdit" href="/LaboratoryAnimalHousing/findSelectSituationSowById?AnimalNumber=${selectSituationSow.getAnimalNumber()}">
...
<script>
    ...
    layui.use(['jquery', 'excel','form','layer','laydate'], function(){
        ...
        /*添加弹出框*/
        $("#addSelectSituationSowBtn").click(function () {
            layer.open({
                type:1,
                title:"添加母猪档案",
                skin:"myclass",
