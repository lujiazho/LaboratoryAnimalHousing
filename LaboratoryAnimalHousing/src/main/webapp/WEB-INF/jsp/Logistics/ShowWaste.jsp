...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td class="main_locbg font2"><img src="${pageContext.request.contextPath}/resources/ZLJ_resources/images/waste_images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：主页 &gt; 废料查询</td>
    ...
    <tr valign="top">
        <td height="20">
            <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
                ...
                <c:forEach items="${requestScope.wastes}" var="waste" varStatus="stat">
                    <tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
                        <td><input type="checkbox" id="box_${stat.index}" value="${waste.id}"></td>
                        <td><f:formatDate value="${waste.getLoggingdate()}"
                                          type="date" dateStyle="long"/></td>
                        <td>${waste.getWasteweight()}</td>
                        <td>${waste.getRecycable()}</td>
