   ...
   <div class="page-bar" id="pg_div">
       <ul class="page-num-ul">
           ...
           <c:if test="${param.currentPageNo>1}">
                <a class="pg_a" href="javascript:page_nav(document.forms[0],1);" onclick="waiting()">首页</a>
                <a class="pg_a" href="javascript:page_nav(document.forms[0],${param.currentPageNo-1});" onclick="waiting()">上一页</a>
           </c:if>
           <c:if test="${param.currentPageNo<param.totalPageCount}">
                <a class="pg_a" href="javascript:page_nav(document.forms[0],${param.currentPageNo+1});" onclick="waiting()">下一页</a>
                <a class="pg_a" href="javascript:page_nav(document.forms[0],${param.totalPageCount});" onclick="waiting()">最后一页</a>
           </c:if>
           </li>
       </ul>
