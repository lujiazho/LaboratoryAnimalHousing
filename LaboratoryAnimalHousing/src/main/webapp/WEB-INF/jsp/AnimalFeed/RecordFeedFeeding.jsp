...
<div class="x-body">
    <form class="layui-form" action="/LaboratoryAnimalHousing/updateFeedFeeding" method="post"  id="f_auto" accept-charset="UTF-8">
        <input type="hidden" value="${sessionScope.s.getFeedingNumber()}" name="FeedFeedingNumber" id="FeedFeedingNumber"/>
        <div class="layui-form-item">
            <label for="FeedDate" class="layui-form-label">
                <span class="f_sp">投喂日期</span>
            </label>
            <div class="layui-input-inline">
                <input type="text" id="FeedDate" name="FeedDate_"
                       autocomplete="off" value="${sessionScope.s.getFeedDate()}" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="AnimalNumber" class="layui-form-label">
                <span class="f_sp">动物编号</span>
            </label>
            <div class="layui-input-inline">
                <input type="text" id="AnimalNumber" name="AnimalNumber"
                       autocomplete="off" value="${sessionScope.s.getAnimalNumber()}" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <label for="FeedAmount" class="layui-form-label">
                <span class="f_sp">饲料数量</span>
            </label>
            <div class="layui-input-inline">
                <input type="text" id="FeedAmount" name="FeedAmount"
                       autocomplete="off" value="${sessionScope.s.getFeedAmount()}" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="PersonnelNumber" class="layui-form-label">
                <span class="f_sp">喂养人员编号</span>
            </label>
            <div class="layui-input-inline">
