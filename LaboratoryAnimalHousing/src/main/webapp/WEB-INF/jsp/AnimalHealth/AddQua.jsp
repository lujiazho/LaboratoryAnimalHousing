...
<form class="layui-form" method="post" action="/LaboratoryAnimalHousing/AnimalHealthLogin/qualogin">
    ...
    <div class="layui-form-item input-item">
        ...
        <input type="text" placeholder="请输入动物状态"  autocomplete="off" id="info" name="info" class="layui-input">
    </div>
    <div class="layui-form-item input-item">
        <label for="cons">检疫结果</label>
        <input type="text" placeholder="请输入动物健康状态"  autocomplete="off" id="cons" name="cons" class="layui-input" >
    </div>
    <div class="layui-form-item input-item">
        <label for="name">检疫员姓名</label>
        <input type="text" placeholder="请输入动物接收日期"  autocomplete="off" id="name" name="name" class="layui-input" >
    </div>
