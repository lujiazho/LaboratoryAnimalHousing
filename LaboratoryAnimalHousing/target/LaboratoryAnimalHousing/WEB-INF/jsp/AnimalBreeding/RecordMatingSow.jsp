...
<div class="x-body">
    <form class="layui-form" action="/LaboratoryAnimalHousing/updateMatingSow" method="post"  id="f_auto" accept-charset="UTF-8">
        <div class="layui-form-item"><xblock>修改母猪配种行为记录</xblock></div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" readonly="readonly" id="ActionID" name="ActionID"
                       autocomplete="off" value="${sessionScope.matingSow.getActionID()}" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" readonly="readonly" id="AnimalNumber" name="AnimalNumber"
                       autocomplete="off" value="${sessionScope.matingSow.getAnimalNumber()}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" readonly="readonly" id="BehaviorStartTime" name="BehaviorStartTime"
                       autocomplete="off" value="${sessionScope.matingSow.getBehaviorStartTime()}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="BehaviorEndTime" name="BehaviorEndTime"
                       autocomplete="off" value="${sessionScope.matingSow.getBehaviorEndTime()}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="BehaviorDescription" name="BehaviorDescription"
                       autocomplete="off" value="${sessionScope.matingSow.getBehaviorDescription()}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="TreatmentPlan" name="TreatmentPlan"
                       autocomplete="off" value="${sessionScope.matingSow.getTreatmentPlan()}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="TreatmentResult" name="TreatmentResult"
                       autocomplete="off" value="${sessionScope.matingSow.getTreatmentResult()}" class="layui-input">
            </div>
        </div>
