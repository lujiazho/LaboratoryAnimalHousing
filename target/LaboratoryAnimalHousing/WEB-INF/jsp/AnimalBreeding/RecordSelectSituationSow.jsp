...
<div class="x-body">
    <form class="layui-form" action="/LaboratoryAnimalHousing/updateSelectSituationSow" method="post"  id="f_auto" accept-charset="UTF-8">
        <div class="layui-form-item"><xblock>维护母猪档案</xblock></div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" readonly="readonly" id="AnimalNumber" name="AnimalNumber"
                       autocomplete="off" value="${sessionScope.selectSituationSow.getAnimalNumber()}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="HealthCondition" name="HealthCondition"
                       autocomplete="off" value="${sessionScope.selectSituationSow.getHealthCondition()}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="LifeCondition" name="LifeCondition"
                       autocomplete="off" value="${sessionScope.selectSituationSow.getLifeCondition()}" class="layui-input">
            </div>
        </div>
