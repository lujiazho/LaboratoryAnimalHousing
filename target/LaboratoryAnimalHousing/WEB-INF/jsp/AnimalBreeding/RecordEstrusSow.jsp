...
<div class="x-body">
    <form class="layui-form" action="/LaboratoryAnimalHousing/updateEstrusSow" method="post"  id="f_auto" accept-charset="UTF-8">
        <div class="layui-form-item"><xblock>修改母猪发情行为记录</xblock></div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" readonly="readonly" id="ActionID" name="ActionID"
                       autocomplete="off" value="${sessionScope.estrusSow.getActionID()}" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" readonly="readonly" id="AnimalNumber" name="AnimalNumber"
                       autocomplete="off" value="${sessionScope.estrusSow.getAnimalNumber()}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" readonly="readonly" id="BehaviorStartTime" name="BehaviorStartTime"
                       autocomplete="off" value="${sessionScope.estrusSow.getBehaviorStartTime()}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="BehaviorEndTime" name="BehaviorEndTime"
                       autocomplete="off" value="${sessionScope.estrusSow.getBehaviorEndTime()}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="BehaviorDescription" name="BehaviorDescription"
                       autocomplete="off" value="${sessionScope.estrusSow.getBehaviorDescription()}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="TreatmentPlan" name="TreatmentPlan"
                       autocomplete="off" value="${sessionScope.estrusSow.getTreatmentPlan()}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="TreatmentResult" name="TreatmentResult"
                       autocomplete="off" value="${sessionScope.estrusSow.getTreatmentResult()}" class="layui-input">
            </div>
        </div>

        <div class="layui-form-item" id="btn_xg">
            <button  class="layui-btn"  id="btn_on" lay-filter="updateClass" lay-submit="">修改</button>
        </div>
    </form>
</div>
