...
<div class="x-body">
    <form class="layui-form" action="/LaboratoryAnimalHousing/updateSowRecord" method="post"  id="f_auto" accept-charset="UTF-8">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" readonly="readonly" id="AnimalNumber" name="AnimalNumber"
                       autocomplete="off" value="${sessionScope.sowRecord.getAnimalNumber()}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="Fertility" name="Fertility"
                       autocomplete="off" value="${sessionScope.sowRecord.getFertility()}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="BreedingHistory" name="BreedingHistory"
                       autocomplete="off" value="${sessionScope.sowRecord.getBreedingHistory()}" class="layui-input">
            </div>
        </div>
